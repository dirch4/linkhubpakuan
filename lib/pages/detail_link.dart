          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              ...
              final TextEditingController linkController =
                  TextEditingController();
              String selectedCategory = 'kuisioner'; // Default kategori
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: [
                        DropdownMenuItem(
                            value: 'kuisioner', child: Text('Kuisioner')),
                        DropdownMenuItem(
                            value: 'beasiswa', child: Text('Beasiswa')),
                        DropdownMenuItem(value: 'lomba', child: Text('Lomba')),
                        DropdownMenuItem(
                            value: 'proker', child: Text('Proker')),
                      ],
                      onChanged: (value) {
